<!-- default value -->
@php
    $go_back_url = action([\App\Http\Controllers\ProductController::class, 'index']);
...
<div id="pos-header" class="col-md-12 no-print pos-header">
...
{{--            </a>--}}
            <a href="{{ $go_back_url }}"
               data-placement="bottom"
               class="tw-shadow-[rgba(17,_17,_50,_0.1)_0px_0px_16px] tw-bg-blue-600 hover:tw-bg-blue-700 tw-text-white tw-border-2 tw-border-blue-700 tw-w-auto tw-h-auto tw-py-1 tw-px-4 tw-rounded-md  pull-right">
                <strong><i class="fa fas fa-plus-circle"></i> Management</strong>
            </a>
            ...
            <form method="GET" action="{{ route('switch.user') }}">
                @csrf
                <input type="hidden" name="database" value="beta">
                @php
                    $user_id = auth()->id();
                    $color = ($user_id == 2) ? 'success' : 'danger'; // or any other colors you want
                @endphp
...
{{--            </button>--}}
            ...
            <a href="{{ action([\App\Http\Controllers\SellController::class, 'index']) }}"
               data-placement="bottom"
               class="tw-shadow-[rgba(17,_17,_50,_0.1)_0px_0px_16px] tw-bg-red-600 tw-text-white tw-border-2 tw-border-red-700 tw-w-auto tw-h-auto tw-py-1 tw-px-4 tw-rounded-md pull-right">
                <strong><i class="fa fas fa-plus-circle"></i> Sales History</strong>
            </a>
            <a href="{{ action([\App\Http\Controllers\ProductController::class, 'create']) }}"
               data-placement="bottom"
               class="tw-shadow-[rgba(17,_17,_50,_0.1)_0px_0px_16px] tw-bg-red-600 tw-text-white tw-border-2 tw-border-red-700 tw-w-auto tw-h-auto tw-py-1 tw-px-4 tw-rounded-md pull-right">
                <strong><i class="fa fas fa-plus-circle"></i> Add Product</strong>
            </a>
            <a href="{{ action([\App\Http\Controllers\PurchaseController::class, 'create']) }}"
               data-placement="bottom"
               class="tw-shadow-[rgba(17,_17,_50,_0.1)_0px_0px_16px] tw-bg-blue-600 hover:tw-bg-blue-700 tw-text-white tw-border-2 tw-border-blue-700 tw-w-auto tw-h-auto tw-py-1 tw-px-4 tw-rounded-md  pull-right">
                <strong><i class="fa fas fa-plus-circle"></i> Add Purchase</strong>
            </a>
            @can('expense.add')
                <button type="button" title="{{ __('expense.add_expense') }}" data-placement="bottom"
