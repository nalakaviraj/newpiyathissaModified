...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // Single date picker
            $('#single_sell_list_filter_date_range').daterangepicker(singleDateRangeSettings, function(start) {
                single=true;
                $('#single_sell_list_filter_date_range').val(start.format(moment_date_format));
                sell_table.ajax.reload();
            });
                ...
                "ajax": {
                    ...
                    "data": function(d) {
                        if (single==false) {
                            ...
                            d.start_date = start;
                            d.end_date = end;
                        } else if ($('#single_sell_list_filter_date_range').val()) {
                            var single_date = $('#single_sell_list_filter_date_range').data('daterangepicker').startDate.format('YYYY-MM-DD');
                            d.start_date = single_date;
                            d.end_date = '';
                        }
                        d.is_direct_sale = 1;
