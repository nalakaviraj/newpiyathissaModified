...
<div class="col-md-3">
    <div class="form-group">
        {!! Form::label('single_sell_list_filter_date_range', __('report.single_date') . ':') !!}
        {!! Form::text('single_sell_list_filter_date_range', null, ['placeholder' => 'Single Date', 'class' => 'form-control', 'readonly']); !!}
    </div>
</div>
@endif
