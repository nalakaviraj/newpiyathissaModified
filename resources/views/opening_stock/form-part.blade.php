...
{{--		  {!! Form::text('stocks[' . $key . '][' . $variation->id . '][' . $sub_key . '][quantity]', @format_quantity($qty) , ['class' => 'form-control input-sm input_number purchase_quantity input_quantity', 'required']); !!}--}}
			{!! Form::text('quantity1', @format_quantity($product_1_quantity) , ['class' => 'form-control input-sm input_number purchase_quantity input_quantity']); !!}
...
{{--	<td>--}}
{{--		<div class="input-group">--}}
{{--		  {!! Form::text('quantity2', @format_quantity($product_2_quantity) , ['class' => 'form-control input-sm input_number purchase_quantity input_quantity']); !!}--}}
{{--		  <span class="input-group-addon">--}}
{{--		    {{ $product->unit->short_name }}--}}
{{--		  </span>--}}
{{--		</div>--}}
