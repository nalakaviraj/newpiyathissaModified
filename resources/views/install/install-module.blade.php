              ...
              <form class="form" id="details_form" method="post" 
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            @if($intruction_type == 'uf')
                                <p class="help-block"><a href="https://NAVIfosters.com/docs/NAVI-fosters-shop/license-key/#Getting-License-Details-for-products-purchased-from-NAVIfosterscom" target="_blank">Where is my License Key?</a></p>
                            @endif
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            @if($intruction_type == 'uf')
                                <p class="help-block"><a href="https://NAVIfosters.com/docs/NAVI-fosters-shop/user-name/#Steps-to-get-your-username-for-all-products-purchased-from-NAVIFosters" target="_blank" class="text-success">Where is my Username?</a></p>
                            @endif
