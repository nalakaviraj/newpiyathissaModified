...
<section class="content">
    ...
    <div class="row no-print">
        ...
        <!-- Date range filter: 3 columns -->
        <div class="col-md-3 col-xs-6 pull-right">
            <div class="form-group">
                <div class="input-group">
                    <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm w-100" id="purchase_sell_date_filter">
                    <span>
        ...
        <!-- Single date filter: 3 columns -->
        <div class="col-md-3 col-xs-6 pull-right">
            <div class="form-group">
                <div class="input-group">
                    <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm w-100" id="purchase_sell_single_date_filter">
                    <span>
                        <i class="fa fa-calendar"></i> Single Date
                    </span>
                        <i class="fa fa-caret-down"></i>
                    </button>
                </div>
