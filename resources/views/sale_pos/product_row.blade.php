...
<tr class="product_row" data-row_index="{{$row_count}}" @if(!empty($so_line)) data-so_id="{{$so_line->transaction_id}}" @endif>
	...
	<td>
		...
		<span class="text-link text-info cursor-pointer" data-toggle="modal" style="color:#E91E63 !important;font-size: 18px;font-weight: bold;" data-target="#row_edit_product_price_modal_{{$row_count}}">
			{!! $product_name !!}
